...
document.getElementById('student-form').style.left="2000px";
document.getElementById('student-form').style.opacity="0";
document.getElementById('mentor-form').style.left="15px";
document.getElementById('mentor-form').style.right="15px";
document.getElementById('mentor-form').style.opacity="1";
...
// document.getElementById('mentor-form3').style.left="2000px";
// document.getElementById('mentor-form3').style.opacity="0";
 document.getElementById('mentor-form').style.left="2000px";
 document.getElementById('mentor-form').style.opacity="0";
 document.getElementById('student-form').style.left="15px";
 document.getElementById('student-form').style.right="15px";
document.getElementById('student-form').style.opacity="1";
